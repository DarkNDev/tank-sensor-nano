...
const uint8_t PIN_RELAY_START_1 = 6;
const uint8_t PIN_RELAY_START_2 = 7;
const uint8_t PIN_RELAY_STOP = 8;

const uint8_t PIN_LOW_PROBE_LED = 10;
const uint8_t PIN_FULL_PROBE_LED = 9;
const uint8_t PIN_MOTOR_STATUS_LED = 2;
